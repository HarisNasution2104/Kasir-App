...
<script>
    ...
    $(function () {
        ...
        // Mengatur checkbox di header
        $('[name=select_all]').on('click', function () {
            $(':checkbox').prop('checked', this.checked);
        });

        // Mengatur checkbox di setiap baris
        $('.table').on('click', '[name="id_produk[]"]', function () {
            $('[name=select_all]').prop('checked', $(':checkbox:checked').length === $(':checkbox').length);
        });
    });
