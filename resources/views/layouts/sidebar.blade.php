    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li>
          ...
          <li>
            <a href="#">
                <i class="fa fa-sitemap"></i> <span>Supplier</span>
                <span class="pull-right-container">
                </span>
            </a>
          </li>   
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="{{ route('produk.index') }}"><i class="fa fa-circle-o"></i> Gudang</a></li>
          ...
          <li>
            <li><a href="https://adminlte.io/docs"><i class="fa fa-shopping-cart"></i> <span>Transaction</span></a></li>
            <li class="header">REPORT</li>
            <li class="treeview">
                <a href="#">
                  <i class="fa fa-cloud-download"></i> <span>Pembelian</span>
                  <span class="pull-right-container">
              ...
              <li class="treeview">
                <a href="#">
                  <i class="fa fa-cloud-upload"></i> <span>Penjualan</span>
                  <span class="pull-right-container">
                    <i class="fa fa-angle-left pull-right"></i>
                  </span>
                </a>
